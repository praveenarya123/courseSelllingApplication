...
function Home() {
  ...
  // token
  //This code runs once when the page loads and checks if the user is logged in by looking for user data in local storage. It updates the login state accordingly.
